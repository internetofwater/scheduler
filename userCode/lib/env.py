...
GLEANER_SHACL_VALIDATOR_GRPC_ENDPOINT = strict_env(
    "GLEANER_SHACL_VALIDATOR_GRPC_ENDPOINT"
)
GLEANER_USE_SHACL = strict_env_bool("GLEANER_USE_SHACL")
...
MAINSTEM_FILE = repositoryRoot / strict_env("FLATGEOBUF_MAINSTEM_FILE")
