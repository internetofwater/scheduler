...
@schedule(cron_schedule="0 0 1 * *", job=implnet_job_cuahsihisnooksackmicroclimatenetworkids0, default_status=DefaultScheduleStatus.RUNNING, execution_timezone="US/Central")
